...
6. Check the latest GitHub Actions run for the current source commit; older passing runs do not establish release readiness.

Landing receipt/gate examples are explicitly illustrative and are not live evidence.

## Historical evidence (superseded)

- Historical source commit: `5d0009502b7f39a05fc15a7b8b9f5577d3dbd895`
...
- Superseded historical Studionet contract: `0x4A430f7326DEdcd796df149Ce5d31223c5943d92`
...
- That superseded-deployment run exercised profile creation, challenge issuance, surface registration, and semantic verification live. Its semantic readback was `UNVERIFIED` with `identity_relation=UNRESOLVED` and `authenticity=UNRESOLVED`. No proof, gate membership, or room access success is claimed. The currently configured deployment `0xD4d621bBD288496cab9f7f5Ec23C579816D84EB3` is accepted but not confirmed finalized; deployed-source parity is unverified.
